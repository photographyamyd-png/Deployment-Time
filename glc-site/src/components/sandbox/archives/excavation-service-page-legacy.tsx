/**
 * Pre-template excavation hub (home-style sections + custom bands).
 * Preserved for sandbox reference only — production uses `ServicePageView`.
 */
...
export function ExcavationServicePageLegacy() {
  const band = hubParallax.parallaxBand;

  return (
    <div className="sandbox-svc-arch__legacy">
