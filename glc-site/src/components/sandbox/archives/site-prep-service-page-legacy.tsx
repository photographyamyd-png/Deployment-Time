/**
 * Pre-template site prep & grading hub (home-style sections + custom bands).
 * Sandbox reference — production uses `ServicePageView`.
 */
...
export function SitePrepServicePageLegacy() {
