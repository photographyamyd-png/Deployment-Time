...
export function HomeServicesAccgridMotionFig({ imageUrl, title, sizes, fill }: Props) {
  ...
  return (
    <div
      className={
        fill ? "glc-svc-accgrid__fig glc-svc-accgrid__fig--fill" : "glc-svc-accgrid__fig"
      }
      onMouseMove={onMove}
      onMouseLeave={onLeave}
      role="presentation"
    >
      <div className="glc-svc-accgrid__fig-inner" style={innerStyle}>
        <Image src={imageUrl} alt={title} fill className="glc-svc-accgrid__img" sizes={sizes} />
      </div>
    </div>
  );
}
