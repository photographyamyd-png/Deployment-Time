...
export function SitePrepGradingSeoResearch() {
  return (
    <section
      className="exc-research gl-reveal"
      aria-labelledby="site-prep-research-heading"
    >
      <div className="exc-research__inner">
        <div className="exc-research__intro-block">
          ...
          <h2 id="site-prep-research-heading" className="gl-h2 exc-research__heading">
            {research.heading}
          </h2>
