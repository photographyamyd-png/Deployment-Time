...
export function SitePrepGradingGeoHub() {
  return (
    <section className="exc-geo gl-reveal" aria-labelledby="site-prep-geo-heading">
      <div className="exc-geo__inner">
        <div className="exc-geo__mast">
          ...
          <div className="exc-geo__mast-copy">
            ...
            <h2 id="site-prep-geo-heading" className="gl-h2 exc-geo__heading">
              {geo.heading}
            </h2>
